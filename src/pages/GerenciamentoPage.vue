...
const emailsBaixa = [
  { nome: 'WMS Gerência',               email: 'gerencia@wmsconsultoria.com.br' },
  { nome: 'WMS Contábil – Fiscal',       email: 'fiscal@wmsconsultoria.com.br' },
  { nome: 'WMS Contábil – DP',           email: 'pessoal@wmsconsultoria.com.br' },
]
